...
整体像课程角色、贴纸或短视频形象中的软萌 IP，轮廓一眼可辨，亲和、有记忆点。1:1 方形构图，人物居中，全身完整可见，高清。不要添加人物设定未提及的场景和物件，不要使用写实、摄影、3D、多人、文字、Logo 或水印。`,
  },
  {
    ...
    name: 'Chibi 动漫',
    subtitle: '萌系动漫小人',
    description: '动漫风格五官、细致发型和轻赛璐璐上色，角色感更强。',
    image: chibiImage,
    tags: ['Chibi', '赛璐璐', '角色感'],
    stylePrompt: `Chibi 萌系人物插画，精致但简洁的动漫贴纸风格。
...
整体像动漫角色贴纸、游戏头像或直播形象中的萌系小人，必须明显区别于彩铅涂鸦。1:1 方形构图，人物居中，全身完整可见，高清。不要添加人物设定未提及的场景和物件，不要使用摄影、3D、复杂光影、多人、文字、Logo 或水印。`,
  },
];
