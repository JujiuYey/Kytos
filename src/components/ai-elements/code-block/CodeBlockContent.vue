...
<template>
  <div class="relative overflow-auto">
    ...
    ><code
      ...
      ><template v-for="line of keyedLines" :key="line.key"><!-- Line rendering component --><span :class="showLineNumbers ? lineNumberClasses : 'block'"><template v-if="line.tokens.length === 0">{{ '\n' }}</template><template v-else><!-- Token rendering component --><span
                v-for="tokenObj of line.tokens"
                :key="tokenObj.key"
